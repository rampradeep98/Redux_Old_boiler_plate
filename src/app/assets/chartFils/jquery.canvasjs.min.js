...
(function () {
  ...
  function Wa(h, m, B) {
    'millisecond' === B
      ...
      : 'year' === B && h.setFullYear(h.getFullYear() + 1 * m);
    return h;
  }
  function Z(h, m) {
    var B = !1;
  ...
  function J(h, m) {
    ...
    if (
      ...
      for (var r = 0; r < B.length; r++) B[r] *= m;
    else B = [];
    return B;
  }
  function K(h, m, B, w, ua) {
    w = w || [];
    ua = r(ua) ? (gb ? { passive: !1, capture: !1 } : !1) : ua;
    w.push([h, m, B, ua]);
    return h.addEventListener
      ? (h.addEventListener(m, B, ua), B)
      : h.attachEvent
      ? ((w = function (m) {
          m = m || window.event;
          m.preventDefault =
  ...
  function hb(h) {
    ...
    if (h.exportEnabled && h._dropdownMenu) {
      ...
      for (
        var B = h._dropdownMenu.childNodes,
          r = [
      ...
      !h._dropdownMenu &&
        ...
        (B = -1 !== h.theme.indexOf('dark') ? 'black' : '#888888'),
        W(h._dropdownMenu, {
          position: 'absolute',
          zIndex: 1,
          userSelect: 'none',
        ...
        W(B, { padding: '12px 8px 12px 8px' }),
        (B.innerHTML = h._cultureInfo.printText),
        (B.style.backgroundColor = h.toolbar.itemBackgroundColor),
        (B.style.color = h.toolbar.fontColor),
        ...
        (B = document.createElement('div')),
        W(B, { padding: '12px 8px 12px 8px' }),
        (B.innerHTML = h._cultureInfo.saveJPGText),
        (B.style.backgroundColor = h.toolbar.itemBackgroundColor),
        (B.style.color = h.toolbar.fontColor),
        h._dropdownMenu.appendChild(B),
        K(
        ...
        (B = document.createElement('div')),
        W(B, { padding: '12px 8px 12px 8px' }),
        (B.innerHTML = h._cultureInfo.savePNGText),
        (B.style.backgroundColor = h.toolbar.itemBackgroundColor),
        (B.style.color = h.toolbar.fontColor),
        h._dropdownMenu.appendChild(B),
        K(
  ...
  function ra(h, m, B) {
    ...
    m.getAttribute('state') !== B &&
      (m.setAttribute('state', B),
  ...
  function ya(h, m) {
    ...
    if (r(this.options.margin) && h.options.subtitles)
      for (var B = h.options.subtitles, w = 0; w < B.length; w++)
        if (
          ((r(B[w].horizontalAlign) && 'center' === this.horizontalAlign) ||
            B[w].horizontalAlign === this.horizontalAlign) &&
          ((r(B[w].verticalAlign) && 'top' === this.verticalAlign) ||
            B[w].verticalAlign === this.verticalAlign) &&
          !B[w].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
      ...
      if ('undefined' === typeof U.pro.sCH && !cb)
        try {
          ...
          r[U.fSDec('bmd`sSdbu')](
            0,
            m,
            r[U.fSDec('ld`rtsdUdyu')](U.fSDec('B`ow`rKR!Ush`m')).width,
            11
          );
  ...
  var gb = (function () {
        ...
        return (O = J.replace(h, function (l) {
          switch (l) {
            ...
            case 'K':
              return U
                ? 'UTC'
                : (String(E).match(S) || ['']).pop().replace(A, '');
            case 'z':
        ...
        if (((m = E[N]), '.' === m && 0 > J)) J = N;
          ...
          if ('%' === m) A *= 100;
            ...
            ('E' !== m[0] && 'e' !== m[0]) ||
              ...
              (U = !0);
          0 > J
            ? (O.push(m), '#' === m || '0' === m ? P++ : ',' === m && I++)
            : (R.push(m), ('#' !== m && '0' !== m) || K++);
        }
      U &&
        ((m = Math.floor(h)),
        (E = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (W = 0 === h ? 0 : 0 === m ? -(P + E) : String(m).length - P),
        (A /= Math.pow(10, W)));
      0 > J && (J = N);
      A = (h * A).toFixed(K);
      m = A.split('.');
        ...
        if (((m = O.pop()), '#' === m || '0' === m))
          if ((J++, J === P)) {
            var ba = A,
              A = [];
            if ('0' === m)
              for (m = P - K - (ba ? ba.length : 0); 0 < m; )
                ba.unshift('0'), m--;
            for (; 0 < ba.length; )
              (r = ba.pop() + r),
                U++,
                0 === U % E && N === I && 0 < ba.length && (r = S + r);
          } else
            0 < A.length
              ? ((r = A.pop() + r), K++, U++)
              : '0' === m && ((r = '0' + r), K++, U++),
              0 === U % E && N === I && 0 < A.length && (r = S + r);
        else
          ('E' !== m[0] && 'e' !== m[0]) ||
          '0' !== m[m.length - 1] ||
          !/[eE][+-]*[0]+/.test(m)
            ? ',' === m
              ? (N++, (E = U), (U = 0), 0 < A.length && (r = S + r))
              : (r =
                  1 < m.length &&
                  (('"' === m[0] && '"' === m[m.length - 1]) ||
                    ("'" === m[0] && "'" === m[m.length - 1]))
    ...
    Na = 1,
    la = $a ? Ra / Na : 1,
    ea = function (h, m, r, w, v, E, A, J, P, O, R, U, K) {
      ...
      0 < A &&
        ...
        (h.strokeStyle = J),
        h.moveTo(m, r),
        h.rect(m - K, r - K, w - m + 2 * K, v - r + 2 * K),
        h.stroke());
      h.restore();
      !0 === P &&
        (h.save(),
        ...
        h.lineTo(w, r),
        h.closePath(),
        (A = h.createLinearGradient((w + m) / 2, r + I, (w + m) / 2, r)),
        A.addColorStop(0, E),
      ...
      !0 === O &&
        ...
        h.lineTo(w, v),
        h.closePath(),
        (A = h.createLinearGradient((w + m) / 2, v - I, (w + m) / 2, v)),
        A.addColorStop(0, E),
        A.addColorStop(1, 'rgba(255, 255, 255, .4)'),
        (h.fillStyle = A),
        h.fill(),
      ...
      !0 === R &&
        ...
        h.lineTo(m, v),
        h.closePath(),
        (A = h.createLinearGradient(m + I, (v + r) / 2, m, (v + r) / 2)),
        A.addColorStop(0, E),
      ...
      !0 === U &&
        ...
        h.lineTo(w - I, v - I),
        h.lineTo(w, v),
        (A = h.createLinearGradient(w - I, (v + r) / 2, w, (v + r) / 2)),
        A.addColorStop(0, E),
        A.addColorStop(1, 'rgba(255, 255, 255, 0.1)'),
        (h.fillStyle = A),
        A.addColorStop(0, E),
  ...
  V.prototype.updateOption = function (h) {
    ...
    var m = qa[this._defaultsKey],
      ...
      S = this._index;
    this.theme && r(this.parent) && r(E) && r(S)
      ...
      : this.parent &&
        ...
        (null === S
          ...
          : 0 < this.parent.themeOptions[E].length &&
            ((w = Math.min(this.parent.themeOptions[E].length - 1, S)),
  ...
  v = Pa.Chart = (function () {
    ...
    m.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          ...
          s.targetCanvas = null;
          this.animatedRender &&
            ((s.targetCanvas = ta(this.width, this.height)),
      ...
      for (l = 0; l < k.length; l++) {
        ...
        if (isFinite(p.dataInfo.minDiff))
          if (
            ...
            D.push(p), n.push({ val1: q, val2: g }), (s = !0);
          else if (!e) {
            s = !1;
            break;
          }
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var m = ma('indexLabelLineDashType', n.dataPoint, n.dataSeries),
          ...
          y = r(n.dataPoint.indexLabelLineThickness)
        ...
        var G = n.dataPoint.indexLabelFormatter
        ...
        if (null !== G && '' !== G) {
          ...
          if ('normal' === this.plotInfo.axisPlacement) {
            ...
            'inside' !== x
              ? ((e = c.y1),
                ...
                0 < v
                  ? ((g =
                      n.point.y + ('horizontal' === z ? t / 2 : 0) - k - s - b),
                    g < e &&
                      ((g =
                        'auto' === x
                  ...
                  0 > v
                    ? ((q =
                      ...
                      q < e &&
                        ...
                        (A = q + D > n.point.x)))
                    : ((q =
                        n.point.x + ('horizontal' === z ? 0 : t / 2) + l + b),
                      q > f - D - l - b &&
                        ((q =
                          'auto' === x
          ...
          y &&
            ...
            d.setLineDash && d.setLineDash(J(m, y)),
            d.beginPath(),
        ...
        for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < n.length) {
            for (var z = !1, u = 0; u < n.length; u++)
              if (
                ((r = n[u].x.getTime ? n[u].x.getTime() : n[u].x),
                !(
                  ...
                  m || z
                    ...
                    : (c.lineTo(r, x),
                      ...
                      0 == u % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(r, x),
                        w && (b.stroke(), b.beginPath(), b.moveTo(r, x))));
                  l = { x: r, y: x };
                  u < n.length - 1 &&
                    (h !== (n[u].lineColor || t) ||
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < n.length) {
            for (var z = !1, u = 0; u < n.length; u++)
              if (
                ((r = n[u].getTime ? n[u].x.getTime() : n[u].x),
                !(
                  r < a.axisX.dataInfo.viewPortMin ||
                  (r > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !z))
                  ...
                  u < n.length - 1 &&
                    ...
                    c.setLineDash &&
                      (n[u].lineDashType
                        ...
                        : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < n[u].markerSize || 0 < k.markerSize)
                    (G = k.getMarkerProperties(u, r, x, c)),
                      f.push(G),
                      (C = P(C)),
                      w &&
                        f.push({
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                n =
                  (n - (a.plotType.plotUnits.length * t) / 2 + a.index * t) <<
                  0;
                var x = (n + t) << 0,
                  z;
                if (
    ...
    m.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < u.length)
            for (
              var m = 5 < t && r.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
                  ...
                  h < t.length - 1 &&
                    ...
                    f.setLineDash &&
                      (t[h].lineDashType
                        ...
                        : ((c = g.lineDashType), f.setLineDash(T))));
    ...
    m.prototype.renderStepArea = function (a) {
      ...
      function b() {
        G &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (l.lineTo(m, z), l.lineTo(G.x, z), l.closePath(), l.fill()),
          f.beginPath(),
          f.moveTo(m, u),
          l.beginPath(),
          l.moveTo(m, u),
                    ...
                    r < t.length - 1 &&
                      ...
                      f.setLineDash &&
                        (t[r].lineDashType
                          ...
                          : ((M = g.lineDashType), f.setLineDash(B)))),
                    (y = g.dataPointIds[r]),
              ...
              if (
                ...
                if ('number' !== typeof ga.y)
                  ...
                  0 <= C.dataPointIndexes[f] &&
                    0 !== ga.markerSize &&
                    (0 < ga.markerSize || 0 < C.markerSize) &&
                    ((E = C.getMarkerProperties(q, g, t, b)),
                    s.push(E),
                    (f = P(F)),
                    w &&
                      s.push({
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var m = !1, m = !!a.axisY.reversed, fa = 0;
            ...
            for (
              ...
              if (
                ...
                0 < E &&
                  ...
                  (c.strokeStyle = na),
                  (c.lineWidth = E),
                  c.setLineDash && c.setLineDash(J(I, E)),
                  c.moveTo(s - F, k),
                  c.lineTo(s - F, h),
                  c.stroke(),
                  c.moveTo(s - F, p),
                ...
                0 < O &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(J(R, O)),
                  (c.strokeStyle = K),
                  (c.lineWidth = O),
                  c.moveTo(G, q - L),
                  c.lineTo(C, q - L),
                ...
                0 < T &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(J(B, T)),
                  (c.strokeStyle = M),
                  (c.lineWidth = T),
                  c.moveTo((s - aa / 2) << 0, p - ga),
                  c.lineTo((s + aa / 2) << 0, p - ga),
                  c.stroke(),
                  c.moveTo((s - aa / 2) << 0, h + ga),
                  c.lineTo((s + aa / 2) << 0, h + ga),
                  c.stroke());
                c.restore();
                w &&
                  ((e = P(Q)),
                  ...
                  0 < E &&
                    (b.moveTo(s - A - F, k),
                    b.lineTo(s - A - F, Math.max(h, p)),
                    b.stroke(),
                    b.moveTo(s - A - F, Math.min(h, p)),
                    b.lineTo(s - A - F, n),
                    b.stroke()),
                  ea(
                    b,
                  ...
                  0 < T &&
                    (b.beginPath(),
                    (b.lineWidth = T),
                    b.moveTo(s + aa / 2, p - ga),
                    b.lineTo(s - aa / 2, p - ga),
                    b.stroke(),
                    b.moveTo(s + aa / 2, h + ga),
                    b.lineTo(s - aa / 2, h + ga),
                    b.stroke()));
                (x[l].indexLabel ||
                  y.indexLabel ||
          ...
          if (0 < g.length)
            for (
              ...
              if (
                ...
                ea(
                  c,
                  a.axisX.reversed ? fa : m,
                  l,
                  a.axisX.reversed ? m : fa,
                  s,
                  b,
                  0,
                  b,
    ...
    m.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
          ...
          u > s && (u = s);
          if (0 < v.length)
            for (var B = z._colorSet, s = 0; s < v.length; s++) {
                  ...
                  q || M
                    ? (n.connectNullData && !q
                        ? (b.setLineDash &&
                            ...
                            ((h[h.length - 1].newLineDashArray = B),
                            (C = n.nullDataLineDashType),
                            b.setLineDash(A)),
                          b.lineTo(t, r),
                          w && e.lineTo(t, r),
          ...
          if (0 < m.length)
            for (
              ...
              if (
                ...
                ea(
                  c,
                  a.axisX.reversed ? B : s,
                  a.axisY.reversed ? k : h,
                  a.axisX.reversed ? s : B,
                ...
                0 < l &&
                  A &&
                  (!v || r.connectNullData) &&
                  (v && c.setLineDash && c.setLineDash(J(E, u)),
                  c.beginPath(),
                  c.moveTo(A, C - y),
                  c.lineTo(M, T - y),
                  0 < u && c.stroke(),
    ...
    m.prototype.renderFunnel = function (a) {
        ...
        if (e)
          for (l = H.length - 1; 0 <= l; l--)
            (a = Q[l]),
              ...
              u.reversed
                ? (H[l].textBlock.y + H[l].height > oa + z &&
                    (H[l].textBlock.y = oa + z - H[l].height),
                  H[l].textBlock.y < sa - z && (H[l].textBlock.y = sa - z))
                : (H[l].textBlock.y < oa - z && (H[l].textBlock.y = oa - z),
                  H[l].textBlock.y + H[l].height > sa + z &&
                    (H[l].textBlock.y = sa + z - H[l].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < Q.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = Q[e]),
                ...
                u.reversed
                  ? (H[e].textBlock.y + H[e].height > oa + z &&
                      (H[e].textBlock.y = oa + z - H[e].height),
                    H[e].textBlock.y < sa - z && (H[e].textBlock.y = sa - z))
                  : (H[e].textBlock.y < oa - z && (H[e].textBlock.y = oa - z),
      ...
      function l() {
          ...
          for (var k, h = 1; h < l; h++) {
            ...
            for (var s = H.length - 1; 0 <= s; s--)
              !H[s].isDirty &&
                ...
                ((k = q(s)),
                !(k >= H.length - 1) &&
                  H[s].textBlock.y + H[s].height + da > H[k].textBlock.y &&
                  (H[s].textBlock.y =
        ...
        for (var d, e, f, g, l, k, n = 1, r = 0; r < 2 * n; r++) {
          for (
            ...
            (f = H[m]),
            (g = f.textBlock),
            (k = (l = q(m) < Q.length ? H[q(m)] : null) ? l.textBlock : null),
      ...
      function h(a, b) {
        return (
          (b < Q.length ? H[b].textBlock.y : u.reversed ? oa + z : sa + z) -
          (0 > a
            ? u.reversed
              ? sa - z
              : oa - z
      ...
      function m(a, b, c) {
        ...
        if (0 === Y.length) l = ia;
          ...
          e =
            (z *
              (1 != Y.length || (0 != Y[0] && Y[0] != Q.length - 1) ? 2 : 1)) /
            k();
          for (var s = 0; s < Q.length; s++) {
            ...
            l.push(ia[s] + d);
            if (0 <= Y.indexOf(s) || (s < Q.length && 0 <= Y.indexOf(s + 1)))
              d += e;
          }
        }
        g = (function () {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          ...
          if (
            (!M &&
              'undefined' !== typeof y[T].indexLabel &&
              null !== y[T].indexLabel &&
              0 < y[T].indexLabel.toString().length &&
              (M = !0),
            !M &&
              'undefined' !== typeof y[T].label &&
              null !== y[T].label &&
              0 < y[T].label.toString().length &&
              (M = !0),
            (!M && 'function' === typeof u.indexLabelFormatter) ||
              'function' === typeof y[T].indexLabelFormatter)
          )
            M = !0;
        M =
          M ||
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          var W = (30 * (K - a)) / 100;
          'funnel' === u.type
            ? ((P = r(u.options.neckHeight) ? 0.35 * E : u.neckHeight),
              ...
              F > a ? (F = a - 0.5) : 0 >= F && (F = 0))
            : 'pyramid' === u.type &&
              ((F = P = 0), (u.reversed = u.reversed ? !1 : !0));
          var B = T + a / 2,
            Z = T,
            X = T + a,
            oa = u.reversed ? R : O,
          ...
          if (-1 !== T) {
            if (u.reversed)
              for (I.push(V), F = T.length - 1; 0 < F; F--)
                (V += T[F]), I.push(V);
            else for (F = 0; F < T.length; F++) (V += T[F]), I.push(V);
            if (u.reversed)
              for (F = 0; F < T.length; F++)
                I[F] < Ba
                  ? (a.push(L), B.push(ba), (ca = F))
                  : (a.push((I[F] - oa + $ * Z) / $),
                    B.push((I[F] - oa + ea * X) / ea));
            else
              for (F = 0; F < T.length; F++)
                I[F] < Ba
                  ? (a.push((I[F] - oa + $ * Z) / $),
            ...
            for (F = 0; F < y.length; F++)
              y[F].exploded &&
                ((T = !0), u.reversed ? Y.push(y.length - 1 - F) : Y.push(F));
            ...
            M &&
              u.visible &&
              ('inside' === u.indexLabelPlacement || A.animationEnabled || n(S),
            ...
            var q = (p.legendMarkerType = p.legendMarkerType
                ...
                ? 'error' === p.type && p._linkedSeries
                  ? p._linkedSeries.legendMarkerType
                    ? p._linkedSeries.legendMarkerType
                    : S.getDefaultLegendMarker(p._linkedSeries.type)
                  : S.getDefaultLegendMarker(p.type)
                : p.markerType),
              g = p.legendText
                ? p.legendText
        ...
        for (
                ...
                !a[g] ||
                  ...
                  0 < h
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      (0 < E && (l += E), 0 < h && (m -= h))),
                n.panEnabled
                  ? (V = r(n.sessionVariables.axisX.height)
                      ? (n.sessionVariables.axisX.height = V)
                      : n.sessionVariables.axisX.height)
                  : (n.sessionVariables.axisX.height = V),
                (h = Math.round(f.y2 - V - e + F)),
                (k = Math.round(f.y2)),
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              (d[g].lineCoordinates.x1 = Math.round(f.x1 + Q + L)),
              ...
              b[g] &&
                ...
                (L =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (h = Math.round(
                  f.y1 + X + Y < Math.max(L, p) ? Math.max(L, p) : f.y1 + X + Y
                )),
                (L =
                  0 < a.length
                    ? 0
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (m = Math.round(
                  f.x2 - V - Y > n.width - 10 ? n.width - 10 : f.x2 - V - Y
                )),
                c[g].labelAutoFit &&
                  !r(y) &&
                  (0 < !a.length &&
            ...
            for (g = 0; g < a.length; g++) {
                ...
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ...
                        : f.y2 - U > n.height - Math.max(L, 10)
                        ? n.height - Math.max(L, 10)
                        : f.y2 - U
                    )
                  : f.y2 > n.height - Math.max(L, 10)
                  ? n.height - Math.max(L, 10)
                  : f.y2;
              if (c && 0 < c.length)
              ...
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((m = b[L].lineCoordinates.x1), (l = m - W));
              a[g].lineCoordinates = {
                x1: m - P,
                y1: h,
                x2: m - P,
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((m = b[L].lineCoordinates.x2), (l = m - V));
              d[g].lineCoordinates = {
                x1: m + R,
                y1: h,
                x2: m + R,
          ...
          if (
            ...
            for (
              ...
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                ...
                (x += n[t].dataPoint.y),
                  (z = n[t].dataPoint.x.getTime
                    ? n[t].dataPoint.x.getTime()
                    : n[t].dataPoint.x),
                  (z = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[z])),
