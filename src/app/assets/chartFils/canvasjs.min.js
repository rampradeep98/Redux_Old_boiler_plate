...
(function () {
  ...
  function Ca(h) {
    h.roundRect = function (h, E, s, w, pa, A, B, v) {
      B && (this.fillStyle = B);
      ...
      this.beginPath();
      this.moveTo(h + pa, E);
      this.lineTo(h + s - pa, E);
      this.quadraticCurveTo(h + s, E, h + s, E + pa);
      this.lineTo(h + s, E + w - pa);
      this.quadraticCurveTo(h + s, E + w, h + s - pa, E + w);
      this.lineTo(h + pa, E + w);
      this.quadraticCurveTo(h, E + w, h, E + w - pa);
      this.lineTo(h, E + pa);
      this.quadraticCurveTo(h, E, h + pa, E);
      this.closePath();
      B && this.fill();
      v && 0 < A && this.stroke();
    };
  ...
  function J(h, m) {
    ...
    if (
      ...
      for (var s = 0; s < E.length; s++) E[s] *= m;
    else E = [];
    return E;
  }
    ...
    w && ab
      ? ((wa =
        ...
        Sa !== Oa &&
          ...
          (h.style.height = E + 'px'),
          wa.scale(la, la)))
      : ((h.width = m), (h.height = E));
  }
  function ib(h) {
    if (!jb) {
      var m = !1,
        E = !1;
      'undefined' === typeof ta.Chart.creditHref
  ...
  function ra(h, m, s) {
    ...
    m.getAttribute('state') !== s &&
      (m.setAttribute('state', s),
    ...
    m.setAttribute('title', h._cultureInfo[s + 'Text']);
  }
  function Ma() {
  ...
  function Ta(h, m, s, w, ha) {
    ...
    return !isNaN(h) && h <= m && 0 <= h ? h : 'undefined' === typeof s ? m : s;
  }
  ...
  function Ja(h, m, s) {
    Ja.base.constructor.call(this, 'Subtitle', 'subtitles', m, s, h);
    this.chart = h;
    this.canvas = h.canvas;
    this.ctx = this.chart.ctx;
  ...
  var Ia = !1,
    ...
    za = {
      ...
      colorSet2:
        '#19d916 #180de0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C'.split(
          ' '
        ),
      colorSet3:
  ...
  var fa = 20,
        ...
        if (((m = J[M]), '.' === m && 0 > K)) K = M;
          ...
          if ('%' === m) A *= 100;
            ...
            ('E' !== m[0] && 'e' !== m[0]) ||
              ...
              (G = !0);
          0 > K
            ? (O.push(m), '#' === m || '0' === m ? P++ : ',' === m && V++)
            : (X.push(m), ('#' !== m && '0' !== m) || T++);
        }
      G &&
        ((m = Math.floor(h)),
        (J = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (Q = 0 === h ? 0 : 0 === m ? -(P + J) : nb(m).length - P),
        (A /= Math.pow(10, Q)));
      0 > K && (K = M);
      A = (h * A).toFixed(T);
      m = A.split('.');
        ...
        if (((m = O.pop()), '#' === m || '0' === m))
          if ((K++, K === P)) {
            var W = A,
              A = [];
            if ('0' === m)
              for (m = P - T - (W ? W.length : 0); 0 < m; ) W.unshift('0'), m--;
            for (; 0 < W.length; )
              (s = W.pop() + s),
                G++,
          ...
          !/[eE][+-]*[0]+/.test(m)
            ? ',' === m
              ...
              : (s =
                  ...
                  (('"' === m[0] && '"' === m[m.length - 1]) ||
                    ("'" === m[0] && "'" === m[m.length - 1]))
                    ? m.slice(1, m.length - 1) + s
                    : m + s)
            : ((m =
                0 > Q
                  ? m.replace('+', '').replace('-', '')
                  : m.replace('-', '')),
              (s += m.replace(/[0]+/, function (a) {
    ...
    Pa = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ? ((m = h.offsetX), (s = h.offsetY))
        : h.layerX || 0 == h.layerX
        ? ((m = h.layerX), (s = h.layerY))
    ...
    Oa = 1,
    la = ab ? Sa / Oa : 1,
    Y = function (h, m, s, w, v, B, A, J, K, O, X, T, P) {
      'undefined' === typeof P && (P = 1);
      A = A || 0;
      J = J || 'black';
      var G = 15 < w - m && 15 < v - s ? 8 : 0.35 * Math.min(w - m, v - s);
      h.beginPath();
      h.moveTo(m, s);
      h.save();
      h.fillStyle = B;
      h.globalAlpha = P;
      h.fillRect(m, s, w - m, v - s);
      h.globalAlpha = 1;
      0 < A &&
        ((P = 0 === A % 2 ? 0 : 0.5),
        h.beginPath(),
        ...
        (h.strokeStyle = J),
        h.moveTo(m, s),
        h.rect(m - P, s - P, w - m + 2 * P, v - s + 2 * P),
        h.stroke());
      h.restore();
      !0 === K &&
        (h.save(),
        ...
        h.lineTo(w, s),
        h.closePath(),
        (A = h.createLinearGradient((w + m) / 2, s + G, (w + m) / 2, s)),
        A.addColorStop(0, B),
      ...
      !0 === X &&
        ...
        h.lineTo(m, v),
        h.closePath(),
        (A = h.createLinearGradient(m + G, (v + s) / 2, m, (v + s) / 2)),
        A.addColorStop(0, B),
  ...
  G.prototype.setOptions = function (h, m) {
    if (ta[this._defaultsKey]) {
      var s = ta[this._defaultsKey],
        w;
      for (w in s)
        'publicProperties' !== w &&
          s.hasOwnProperty(w) &&
  ...
  G.prototype.set = function (h, m, s) {
    s = 'undefined' === typeof s ? !0 : s;
    var w = ta[this._defaultsKey];
  ...
  G.prototype.addTo = function (h, m, s, w) {
    w = 'undefined' === typeof w ? !0 : w;
    var v = ta[this._defaultsKey];
    v.hasOwnProperty(h) ||
    (v.publicProperties &&
    ...
    if ('undefined' !== typeof h || this.options._isPlaceholder)
      if (
        ...
        var m = this.parent.options[this.optionsName],
          s = m.length;
        this.options._isPlaceholder || (Da(m), (s = m.indexOf(this.options)));
  ...
  G.prototype.addEventListener = function (h, m, s) {
    h &&
      m &&
  ...
  G.prototype.dispatchEvent = function (h, m, s) {
  ...
  ja.prototype._getLineWithWidth = function (h, m, s) {
    h = String(h);
  ...
  var Qa = {
    ...
    formatNumber: function (h, s, w) {
      w = w || 'en';
      if (La[w]) return ca(h, s || '#,##0.##', new Ka(w));
      throw 'Unknown Culture Name';
    },
    formatDate: function (h, s, w) {
      w = w || 'en';
      if (La[w]) return Aa(h, s || 'DD MMM YYYY', new Ka(w));
      throw 'Unknown Culture Name';
    },
  };
  ...
  B = Qa.Chart = (function () {
    ...
    function v(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b = (a[l].y - a[f].y) / b;
          c[c.length] =
            (a[u].x > a[f].x && 0 < D) || (a[u].x < a[f].x && 0 > D)
              ? { x: a[u].x + D / 3, y: a[u].y + b / 3 }
              : { x: a[u].x, y: a[u].y + b / 9 };
          u = e;
          f = 0 === u ? 0 : u - 1;
          l = u === a.length - 1 ? u : u + 1;
    ...
    function B(a, d, c, b, e, f, l, u, D, k) {
      var n = 0;
      ...
      a.setLineDash && a.setLineDash(J(u.dashType, u.thickness));
      a.beginPath();
      D && 0 < u.thickness
    ...
    m.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          ...
          var u = f.plotUnits[l],
            D = null;
          u.targetCanvas && xa(u.targetCanvas);
          u.targetCanvas = null;
          this.animatedRender &&
          ...
          'line' === u.type
            ? (D = this.renderLine(u))
            : 'stepLine' === u.type
            ? (D = this.renderStepLine(u))
            : 'spline' === u.type
            ? (D = this.renderSpline(u))
            : 'column' === u.type
            ? (D = this.renderColumn(u))
            : 'bar' === u.type
            ? (D = this.renderBar(u))
            : 'area' === u.type
            ? (D = this.renderArea(u))
            : 'stepArea' === u.type
            ? (D = this.renderStepArea(u))
            : 'splineArea' === u.type
            ? (D = this.renderSplineArea(u))
            : 'stackedColumn' === u.type
            ? (D = this.renderStackedColumn(u))
            : 'stackedColumn100' === u.type
            ? (D = this.renderStackedColumn100(u))
            : 'stackedBar' === u.type
            ? (D = this.renderStackedBar(u))
            : 'stackedBar100' === u.type
            ? (D = this.renderStackedBar100(u))
            : 'stackedArea' === u.type
            ? (D = this.renderStackedArea(u))
            : 'stackedArea100' === u.type
            ? (D = this.renderStackedArea100(u))
            : 'bubble' === u.type
            ? (D = D = this.renderBubble(u))
            : 'scatter' === u.type
            ? (D = this.renderScatter(u))
            : 'pie' === u.type
            ? this.renderPie(u)
            : 'doughnut' === u.type
            ? this.renderPie(u)
            : 'funnel' === u.type
            ? (D = this.renderFunnel(u))
            : 'pyramid' === u.type
            ? (D = this.renderFunnel(u))
            : 'candlestick' === u.type
            ? (D = this.renderCandlestick(u))
            : 'ohlc' === u.type
            ? (D = this.renderCandlestick(u))
            : 'rangeColumn' === u.type
            ? (D = this.renderRangeColumn(u))
            : 'error' === u.type
            ? (D = this.renderError(u))
            : 'rangeBar' === u.type
            ? (D = this.renderRangeBar(u))
            : 'rangeArea' === u.type
            ? (D = this.renderRangeArea(u))
            : 'rangeSplineArea' === u.type
            ? (D = this.renderRangeSplineArea(u))
            : 'waterfall' === u.type
            ? (D = this.renderWaterfall(u))
            : 'boxAndWhisker' === u.type && (D = this.renderBoxAndWhisker(u));
          for (var k = 0; k < u.dataSeriesIndexes.length; k++)
            this._dataInRenderedOrder.push(this.data[u.dataSeriesIndexes[k]]);
          this.animatedRender &&
            ((u.targetCanvasCtx.miterLimit = e), D && c.push(D));
        }
          ...
          if ('normal' === u.axisPlacement || 'xySwapped' === u.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (u.dataPoints[D].x && u.dataPoints[D].x.getTime) ||
            'dateTime' === u.xValueType
          )
            f = !0;
          for (D = 0; D < u.dataPoints.length; D++) {
            'undefined' === typeof u.dataPoints[D].x &&
              (u.dataPoints[D].x = D + (a.axisX.logarithmic ? 1 : 0));
            u.dataPoints[D].x.getTime
              ? ((f = !0), (b = u.dataPoints[D].x.getTime()))
              : (b = u.dataPoints[D].x);
            e = u.dataPoints[D].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < D) {
              if (a.axisX.logarithmic) {
                var r = b / u.dataPoints[D - 1].x;
                1 > r && (r = 1 / r);
                c.minDiff > r && 1 !== r && (c.minDiff = r);
              } else
                (r = b - u.dataPoints[D - 1].x),
                  0 > r && (r *= -1),
                  c.minDiff > r && 0 !== r && (c.minDiff = r);
              null !== e &&
                null !== u.dataPoints[D - 1].y &&
                (a.axisY.logarithmic
                  ? ((r = e / u.dataPoints[D - 1].y),
                    1 > r && (r = 1 / r),
            ...
            if (b < q && !k) null !== e && (p = b);
              ...
              u.dataPoints[D].label &&
                (a.axisX.labels[b] = u.dataPoints[D].label);
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            f = !0;
          for (D = 0; D < u.dataPoints.length; D++)
            'undefined' !== typeof u.dataPoints[D].isCumulativeSum &&
            !0 === u.dataPoints[D].isCumulativeSum
              ? ((u.dataPointEOs[D].cumulativeSumYStartValue = 0),
                (u.dataPointEOs[D].cumulativeSum =
                  0 === D ? 0 : u.dataPointEOs[D - 1].cumulativeSum),
                (u.dataPoints[D].y =
                  0 === D ? 0 : u.dataPointEOs[D - 1].cumulativeSum))
              : 'undefined' !== typeof u.dataPoints[D].isIntermediateSum &&
                !0 === u.dataPoints[D].isIntermediateSum
              ? ((u.dataPointEOs[D].cumulativeSumYStartValue = p),
                (u.dataPointEOs[D].cumulativeSum =
                  0 === D ? 0 : u.dataPointEOs[D - 1].cumulativeSum),
                (u.dataPoints[D].y = 0 === D ? 0 : b),
                (p = 0 === D ? 0 : u.dataPointEOs[D - 1].cumulativeSum),
                (b = 0))
              : ((e =
                  'number' !== typeof u.dataPoints[D].y
                    ? 0
                    : u.dataPoints[D].y),
                (u.dataPointEOs[D].cumulativeSumYStartValue =
                  0 === D ? 0 : u.dataPointEOs[D - 1].cumulativeSum),
                (u.dataPointEOs[D].cumulativeSum =
                  0 === D ? e : u.dataPointEOs[D - 1].cumulativeSum + e),
                (b += e));
          for (D = 0; D < u.dataPoints.length; D++)
            if (
              ('undefined' === typeof u.dataPoints[D].x &&
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              u.dataPointEOs[D].cumulativeSum < d.min &&
                (d.min = u.dataPointEOs[D].cumulativeSum),
              u.dataPointEOs[D].cumulativeSum > d.max &&
                (d.max = u.dataPointEOs[D].cumulativeSum),
              0 < D &&
                (a.axisX.logarithmic
                  ? ((p = b / u.dataPoints[D - 1].x),
                    1 > p && (p = 1 / p),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        u.dataPointEOs[D].cumulativeSum /
                        u.dataPointEOs[D - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < D &&
                (u.dataPointEOs[D - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = u.dataPointEOs[D - 1].cumulativeSum),
                u.dataPointEOs[D - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = u.dataPointEOs[D - 1].cumulativeSum));
              u.dataPointEOs[D].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = u.dataPointEOs[D].cumulativeSum);
              u.dataPointEOs[D].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = u.dataPointEOs[D].cumulativeSum);
            }
          u.axisX.valueType = u.xValueType = f ? 'dateTime' : 'number';
        }
    };
      ...
      if (this.isDrag && 'none' !== this.plotInfo.axisPlacement) {
        ...
        if (
          ...
          if (this.panEnabled)
            ...
            this.overlaidCanvasCtx.fillRect(b, u, D, k);
      ...
      for (l = 0; l < k.length; l++) {
        ...
        if (isFinite(p.dataInfo.minDiff))
          if (
            ...
            D.push(p), n.push({ val1: q, val2: g }), (u = !0);
          else if (!e) {
            u = !1;
            break;
          }
      }
      return { isValid: u, axesWithValidRange: D, axesRanges: n };
    };
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var n = this._indexLabels[a],
          ...
          r = ma('indexLabelFontSize', n.dataPoint, n.dataSeries),
          u = ma('indexLabelFontFamily', n.dataPoint, n.dataSeries),
        ...
        var da = ma('indexLabelLineDashType', n.dataPoint, n.dataSeries),
          t = ma('indexLabelLineColor', n.dataPoint, n.dataSeries),
        ...
        if (
          ...
          m = this.getPercentAndTotal(n.dataSeries, n.dataPoint);
        ...
        var H = n.dataPoint.indexLabelFormatter
          ...
          : null;
        if (null !== H && '' !== H) {
          var m = ma('indexLabelPlacement', n.dataPoint, n.dataSeries),
          ...
          if ('normal' === this.plotInfo.axisPlacement) {
            if (0 <= p.indexOf('line') || 0 <= p.indexOf('area'))
              (m = 'auto'), (u = 4);
            else if (0 <= p.indexOf('stacked')) 'auto' === m && (m = 'inside');
            else if ('bubble' === p || 'scatter' === p) m = 'inside';
            q = n.point.x - ('horizontal' === z ? D / 2 : D / 2 - r / 2);
            'inside' !== m
              ? ((e = c.y1),
                (f = c.y2),
                0 < v
                  ? ((g =
                      n.point.y + ('horizontal' === z ? r / 2 : 0) - k - u - b),
                    g < e &&
                      ((g =
                        'auto' === m
              ...
              'inside' !== m
                ? ((e = c.x1),
                  ...
                  0 > v
                    ? ((q =
                        n.point.x -
                        ('horizontal' === z ? D : D - r / 2) -
                        l -
                        b),
                      q < e &&
                        ((q =
                          'auto' === m ? Math.max(n.point.x, e) + l : e + l),
                        (A = q + D > n.point.x)))
                    : ((q =
                        n.point.x + ('horizontal' === z ? 0 : r / 2) + l + b),
                      q > f - D - l - b &&
                        ((q =
                          'auto' === m
          ...
          x &&
            ...
            d.setLineDash && d.setLineDash(J(da, x)),
            d.beginPath(),
            ...
            0 <= p.indexOf('bar') || ('error' === p && n.axisSwapped)
              ? d.lineTo(
                  q +
                    (0 < n.direction ? -l : D + l) +
                    ('vertical' === z ? -r / 2 : 0),
                  g + ('vertical' === z ? -k / 2 : k / 2 - r / 2) - u
                )
              : 0 <= p.indexOf('column') || ('error' === p && !n.axisSwapped)
              ? d.lineTo(
                  q + D / 2 - ('horizontal' === z ? 0 : r / 2),
                  g +
                    ('vertical' === z
                      ? (g - k < n.point.y ? 0 : -k) + u
        ...
        for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < n.length) {
            for (var z = !1, t = 0; t < n.length; t++)
              if (
                ((m = n[t].x.getTime ? n[t].x.getTime() : n[t].x),
                !(
                ...
                if ('number' !== typeof n[t].y)
                  ...
                  s || z
                    ...
                    : (c.lineTo(m, y),
                      ...
                      0 == t % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(m, y),
                        w && (b.stroke(), b.beginPath(), b.moveTo(m, y))));
                  l = { x: m, y: y };
                  t < n.length - 1 &&
                    (h !== (n[t].lineColor || r) ||
                  ...
                  if (
                    ...
                    var C = k.getMarkerProperties(t, m, y, c);
                    f.push(C);
                    H = X(H);
                    w &&
                      f.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < n.length) {
            for (var z = !1, t = 0; t < n.length; t++)
              if (
                ((m = n[t].getTime ? n[t].x.getTime() : n[t].x),
                !(
                  m < a.axisX.dataInfo.viewPortMin ||
                  (m > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !z))
                ...
                if ('number' !== typeof n[t].y)
                  ...
                  0 !== n[t].markerSize &&
                    (0 < n[t].markerSize || 0 < k.markerSize) &&
                    ((H = k.getMarkerProperties(t, m, y, c)),
                    f.push(H),
                    (C = X(C)),
                    w &&
                      f.push({
              ...
              if (
                ...
                if ('number' !== typeof n[m].y)
                  ...
                  if (
                    ...
                    var H = k.getMarkerProperties(m, t, s, b);
                    l.push(H);
                    z = X(z);
                    w &&
                      l.push({
        ...
        for (n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < r.length)
            for (
              ...
              if (
                (r[f].getTime ? (D = r[f].x.getTime()) : (D = r[f].x),
                !(
          ...
          if (0 < r.length) {
            ...
            for (f = 0; f < r.length; f++)
              if (
                ...
                u = a.axisX.convertValueToPixel(D);
                ...
                Y(
                  ...
                  a.axisX.reversed ? m : u,
                  a.axisY.reversed ? t : l,
                  a.axisX.reversed ? u : m,
                  b,
                  0,
                  null,
                  h,
            ...
            for (k = 0; k < t.length; k++)
              if (
                ...
                if (
                  ...
                  (D[b] = y + (D[b] ? D[b] : 0)),
                    (n = l[b] ? l[b] : q),
                    (l[b] = y = a.axisY.convertValueToPixel(D[b]));
                    ...
                    (n.connectNullData
                      ? b.setLineDash &&
                        ...
                        (n.options.nullDataLineDashType ||
                          !p[q - 1].lineDashType) &&
                        ((x[x.length - 1].newLineDashArray = A),
                  ...
                  q < p.length - 1 &&
                    ...
                    b.setLineDash &&
                      (p[q].lineDashType
                        ...
                        : ((C = n.lineDashType),
                          (x[x.length - 1].newLineDashArray = B))));
                  if (
                    0 !== p[q].markerSize &&
                    (0 < p[q].markerSize || 0 < n.markerSize)
                  ) {
                    var S = n.getMarkerProperties(q, g, r, b);
                    l.push(S);
                    L = X(L);
                    w &&
                      l.push({
    ...
    m.prototype.renderStepArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          c = !1;
          if (0 < r.length) {
            var C = g._colorSet[m % g._colorSet.length],
              v = (g.lineColor = g.options.lineColor || C),
              A = v;
            f.fillStyle = C;
            f.strokeStyle = v;
            ...
            for (; m < r.length; m++)
              if (
                ((x = r[m].x.getTime ? r[m].x.getTime() : r[m].x),
                !(
                ...
                'number' !== typeof r[m].y
                  ...
                  : ((s = a.axisX.convertValueToPixel(x)),
                    (t = a.axisY.convertValueToPixel(r[m].y)),
                    d || c
                      ? (!d && g.connectNullData
                          ? (f.setLineDash &&
                              (g.options.nullDataLineDashType ||
                            ...
                            f.lineTo(s, $),
                            f.lineTo(s, t),
                            w && (l.lineTo(s, $), l.lineTo(s, t)))
                          : (f.beginPath(),
                            f.moveTo(s, t),
                            w && (l.beginPath(), l.moveTo(s, t)),
                            (H = { x: s, y: t })),
                        (c = d = !1))
                      : (f.lineTo(s, $),
                        w && l.lineTo(s, $),
                    ...
                    m < r.length - 1 &&
                      (A !== (r[m].lineColor || v) ||
                        L !== (r[m].lineDashType || g.lineDashType)) &&
                      (b(),
                      (A = r[m].lineColor || v),
                      (f.strokeStyle = A),
                      f.setLineDash &&
            ...
            for (var $ = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ('number' !== typeof ga.y)
                  ...
                  q < v.length - 1 &&
                    (L !== (v[q].lineColor || A) ||
                      y !== (v[q].lineDashType || C.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, r),
                    k.push({ x: g, y: m - na }),
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((y = v[q].lineDashType),
                          b.setLineDash(J(y, C.lineThickness)))
                        : ((y = C.lineDashType), b.setLineDash(B))));
                  if (0 <= C.dataPointIndexes[f]) {
                    var ka = C.dataPointIds[C.dataPointIndexes[f]];
            ...
            for (var $ = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ('number' !== typeof ga.y)
                  ...
                  q < v.length - 1 &&
                    (L !== (v[q].lineColor || A) ||
                      t !== (v[q].lineDashType || C.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, r),
                    k.push({ x: g, y: x - ka }),
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((t = v[q].lineDashType),
                          b.setLineDash(J(t, C.lineThickness)))
                        : ((t = C.lineDashType), b.setLineDash(B))));
                  if (0 <= C.dataPointIndexes[f]) {
                  ...
                  0 <= C.dataPointIndexes[f] &&
                    0 !== ga.markerSize &&
                    (0 < ga.markerSize || 0 < C.markerSize) &&
                    ((ka = C.getMarkerProperties(q, g, r, b)),
                    u.push(ka),
                    (f = X(F)),
                    w &&
                      u.push({
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < x.length)
            for (
              var y = 5 < r && t.bevelEnabled ? !0 : !1, u = 0;
              u < x.length;
              u++
            )
              if (
                ...
                var z = (h - r / 2) << 0,
                  ...
                  C = Math.round(Math.max(1, 0.15 * r)),
                  v = 0 === C % 2 ? 0 : 0.5,
                  A = t.dataPointIds[u];
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          var t = a.dataSeriesIndexes[da],
            x = this.data[t],
            y = x.dataPoints;
          if (0 < y.length)
            for (
              var z = 5 < r && x.bevelEnabled ? !0 : !1, l = 0;
              l < y.length;
              l++
            )
              if (
                ...
                var v = (u - r / 2) << 0,
                  C = (u + r / 2) << 0,
                  e = y[l].color ? y[l].color : x._colorSet[0],
                  ...
                  na = y[l].stemColor
                    ...
                    : e,
                  ka =
                    'number' === typeof y[l].stemThickness
                      ? y[l].stemThickness
                      : 'number' === typeof x.options.stemThickness
                      ? x.stemThickness
                      : A,
                  F = 1 === Math.round(ka) % 2 ? 0.5 : 0,
                  E = y[l].stemDashType ? y[l].stemDashType : x.stemDashType,
                  K = y[l].lineColor
                    ? y[l].lineColor
                    : y[l].color
                    ? x.lineColor
                    ...
                    : e,
                  G =
                    'number' === typeof y[l].lineThickness
                      ? y[l].lineThickness
                      : 'number' === typeof x.options.lineThickness
                      ? x.lineThickness
                      : A,
                  O = y[l].lineDashType ? y[l].lineDashType : x.lineDashType,
                ...
                w &&
                  ...
                  0 < ka &&
                    (b.moveTo(u - B - F, k),
                    b.lineTo(u - B - F, Math.max(h, p)),
                    b.stroke(),
                    b.moveTo(u - B - F, Math.min(h, p)),
                    b.lineTo(u - B - F, n),
                    b.stroke()),
                  Y(
                    b,
    ...
    m.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        w &&
          ...
          this._eventManager.ghostCtx.clip());
        for (var da = 0, t = 0; t < this.data.length; t++)
          !this.data[t].type.match(/(bar|column)/gi) ||
            !this.data[t].visible ||
            (this.data[t].type.match(/(stacked)/gi) && da) ||
            da++;
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          ...
          if (C)
            for (e = z._linkedSeries.id, t = 0; t < e; t++)
              !this.data[t].type.match(/(bar|column)/gi) ||
                !this.data[t].visible ||
                (this.data[t].type.match(/(stacked)/gi) && A) ||
                (this.data[t].type.match(/(range)/gi) && (f = !0), A++);
          e = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
          ...
          t > u && (t = u);
          if (0 < v.length)
            for (var E = z._colorSet, u = 0; u < v.length; u++) {
              var e = (z.lineColor = z.options.color ? z.options.color : E[0]),
                L = {
                  color: v[u].whiskerColor
                    ? v[u].whiskerColor
                    : v[u].color
                    ? z.whiskerColor
                      ? z.whiskerColor
                    ...
                    ? z.whiskerColor
                    : e,
                  thickness: s(v[u].whiskerThickness)
                    ? z.whiskerThickness
                    : v[u].whiskerThickness,
                  dashType: v[u].whiskerDashType
                    ? v[u].whiskerDashType
                    : z.whiskerDashType,
                  length: s(v[u].whiskerLength)
                    ? s(z.options.whiskerLength)
                      ? t
                      : z.options.whiskerLength
                    : v[u].whiskerLength,
                  trimLength: s(v[u].whiskerLength)
                    ? s(z.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              var S = {
                color: v[u].stemColor
                  ...
                  ? z.stemColor
                  : e,
                thickness: v[u].stemThickness
                  ? v[u].stemThickness
                  : z.stemThickness,
                dashType: v[u].stemDashType
                  ? v[u].stemDashType
                  : z.stemDashType,
              };
              S.thickness =
                'number' === typeof S.thickness
                  ...
                  : 2;
              v[u].getTime ? (r = v[u].x.getTime()) : (r = v[u].x);
              if (
                !(
                ...
                b ? (k = ea) : (h = ea);
                ea = a.axisY.convertValueToPixel(v[u].y[0]);
                b ? (n = ea) : (q = ea);
                ea = a.axisY.convertValueToPixel(v[u].y[1]);
                b ? (p = ea) : (g = ea);
                b
                  ? ((q = a.axisX.reversed
                      ? (k + ((C ? da : 1) * t) / 2 - (C ? A - 1 : 0) * t) << 0
                      : (k - ((C ? da : 1) * t) / 2 + (C ? A - 1 : 0) * t) <<
                        0),
                    (g = a.axisX.reversed ? (q - t) << 0 : (q + t) << 0))
                  : ((n = a.axisX.reversed
                      ? (h + ((C ? da : 1) * t) / 2 - (C ? A - 1 : 0) * t) << 0
                      : (h - ((C ? da : 1) * t) / 2 + (C ? A - 1 : 0) * t) <<
                        0),
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: b ? (v[u].y[1] >= v[u].y[0] ? n : p) : n + (p - n) / 2,
                      y: b ? q + (g - q) / 2 : v[u].y[1] >= v[u].y[0] ? g : q,
                    },
                    direction: v[u].y[1] >= v[u].y[0] ? -1 : 1,
                    bounds: {
                      x1: b ? Math.min(n, p) : n,
                      y1: b ? q : Math.min(q, g),
                      x2: b ? Math.max(n, p) : p,
                      ...
                      point: {
                        x: b
                          ? v[u].y[1] >= v[u].y[0]
                            ...
                            : n
                          : n + (p - n) / 2,
                        y: b ? q + (g - q) / 2 : v[u].y[1] >= v[u].y[0] ? q : g,
                      },
                      direction: v[u].y[1] >= v[u].y[0] ? 1 : -1,
                      bounds: {
                        x1: b ? Math.min(n, p) : n,
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    var S = n.getMarkerProperties(g, r, s, b);
                    f.push(S);
                    var ea = X(t);
                    w &&
                      f.push({
                    ...
                    S = n.getMarkerProperties(g, r, m, b);
                    f.push(S);
                    ea = X(t);
                    w &&
                      f.push({
            ...
            for (var g = (f = 0); f < d.length - 3; f += 3, g++) {
              if (m[g].newStrokeStyle || m[g].newLineDashArray)
                b.stroke(),
                  b.beginPath(),
                  b.moveTo(d[f].x, d[f].y),
                  m[g].newStrokeStyle && (b.strokeStyle = m[g].newStrokeStyle),
                  m[g].newLineDashArray && b.setLineDash(m[g].newLineDashArray);
              b.bezierCurveTo(
                d[f + 1].x,
                d[f + 1].y,
                d[f + 2].x,
                ...
                if (
                  ...
                  p < n.length - 1 &&
                    ...
                    b.setLineDash &&
                      (n[p].lineDashType
                        ? ((z = n[p].lineDashType),
                          (m[m.length - 1].newLineDashArray = J(
                            z,
                            k.lineThickness
                          )))
                        : ((z = k.lineDashType),
                  ...
                  0 < p &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !n[p - 1].lineDashType) &&
                        ((m[m.length - 1].newLineDashArray = C),
            ...
            for (
              ...
              if (
                ...
                0 < l &&
                  A &&
                  (!z || s.connectNullData) &&
                  (z && c.setLineDash && c.setLineDash(J(B, t)),
                  c.beginPath(),
                  c.moveTo(A, C - x),
                  c.lineTo(L, S - x),
                  0 < t && c.stroke(),
                ...
                c.strokeStyle = v[l].lineColor
                  ...
                  : '#9e9e9e';
                c.lineWidth = t;
                c.setLineDash && ((L = J(L, t)), c.setLineDash(L));
                (v[l].indexLabel ||
                  s.indexLabel ||
    ...
    var qa = function (a, d, c, b, e, f, l, h, m) {
      if (!(0 > c)) {
        ...
        if (0 <= a && a < n.length) {
          ...
          k =
            'right' === p.hemisphere
              ...
              : y.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - y.y, 2));
          m = y.x + C * Math.cos(p.midAngle);
          q = y.y + C * Math.sin(p.midAngle);
          q = Math.sqrt(Math.pow(k - m, 2) + Math.pow(c - q, 2));
          m = Math.acos(C / w);
          q = Math.acos((w * w + C * C - q * q) / (2 * C * w));
          c = q < m ? c - p.indexLabelTextBlock.y : 0;
          k = null;
            ...
            ? ((h = 'right' === p.hemisphere ? m : q),
              ...
              null !== h &&
                ...
                c - m < r &&
                  ((k = -m),
                  (h = f(h, k, d + 1)),
                  +h.toFixed(x) > +k.toFixed(x) &&
                    (l = c > r ? -(c - r) : -(m - (h - k))))))
            : 0 < c &&
              ((h = 'right' === p.hemisphere ? q : m),
              (l = c),
              null !== h &&
                ((m = c),
                (c =
            ...
            for (var u, s, a = 0; a < n.length; a++) {
              ...
              if (null !== t) {
                ...
                var z = 0,
                  z = b(u, s) - r;
                if (0 > z) {
                  for (var A = (s = 0), H = 0; H < n.length; H++)
                    H !== a &&
                  ...
                  'right' === h.hemisphere
                    ? ((H = f(a, s)),
                      (A = -1 * (z - H)),
                      (J = f(t, A)),
                      +J.toFixed(x) < +A.toFixed(x) &&
                        +H.toFixed(x) <= +s.toFixed(x) &&
                        f(a, -(A - J)))
                    : ((H = f(t, s)),
                      (A = -1 * (z - H)),
                      (J = f(a, A)),
                  ...
                  (!l &&
                    ...
                    ((s =
                      0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, t * s) && f(a, 2 * s)),
                  Math.abs(h.indexLabelTextBlock.x - y.x) < C &&
    ...
    m.prototype.renderFunnel = function (a) {
        ...
        if (t && x) {
          for (
            ...
            (r = R[C]),
              ...
              (D[C] = K - r - X);
          r = 0.5 * X;
          for (var C = 0, B = x.length - 1; C < x.length || 0 <= B; C++, B--) {
            b = t.reversed ? x[B] : x[C];
            a = b.color
              ? b.color
              : t.reversed
              ? t._colorSet[(x.length - 1 - C) % t._colorSet.length]
              : t._colorSet[C % t._colorSet.length];
            ...
            q =
              'undefined' !== typeof b.indexLabelWrap
                ...
                : !0;
            m = t.dataPointIds[C];
            A._eventManager.objectMap[m] = {
              id: m,
              objectType: 'dataPoint',
              dataPointIndex: C,
              dataSeriesIndex: 0,
              funnelSection: R[t.reversed ? x.length - 1 - C : C],
            };
            ...
            m = b.indexLabelMaxWidth
              ...
              : D[C];
            if (m > D[C] || 0 > m) m = D[C];
            y[C] = 'inside' === t.indexLabelPlacement ? R[C].height : !1;
            v = A.getPercentAndTotal(t, b);
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
              ? A.replaceKeywordsWithValue(b.indexLabel, b, t, C)
              : t.indexLabelFormatter
              ? t.indexLabelFormatter(z)
              : t.indexLabel
              ? A.replaceKeywordsWithValue(t.indexLabel, b, t, C)
              : b.label
              ? b.label
              : '';
            0 >= n && (n = 0);
            ...
            c = new ja(P, {
              ...
              backgroundColor: d,
              maxWidth: m,
              maxHeight: !1 === y[C] ? (q ? 4.28571429 * f : 1.5 * f) : y[C],
              text: b,
              padding: ca,
            });
            c.measureText();
            ...
            (a = R[l]),
              ...
              t.reversed
                ? (I[l].textBlock.y + I[l].height > U + z &&
                  ...
                  I[l].textBlock.y < sa - z && (I[l].textBlock.y = sa - z))
                : (I[l].textBlock.y < U - z && (I[l].textBlock.y = U - z),
                  I[l].textBlock.y + I[l].height > sa + z &&
                    (I[l].textBlock.y = sa + z - I[l].height));
      }
      function f() {
        var a, b, c, d;
              ...
              : ((a = R[e]),
                ...
                t.reversed
                  ? (I[e].textBlock.y + I[e].height > U + z &&
                    ...
                    I[e].textBlock.y < sa - z && (I[e].textBlock.y = sa - z))
                  : (I[e].textBlock.y < U - z && (I[e].textBlock.y = U - z),
                    I[e].textBlock.y + I[e].height > sa + z &&
                      (I[e].textBlock.y = sa + z - I[e].height)));
        else
      ...
      function l() {
          ...
          for (var k, h = 1; h < l; h++) {
            ...
            for (var m = I.length - 1; 0 <= m; m--)
              !I[m].isDirty &&
                ...
                ((k = q(m)),
                !(k >= I.length - 1) &&
                  I[m].textBlock.y + I[m].height + ca > I[k].textBlock.y &&
                  (I[m].textBlock.y =
        ...
        for (var d, e, f, g, l, k, n = 1, m = 0; m < 2 * n; m++) {
          for (
            ...
            (f = I[r]),
            (g = f.textBlock),
            (k = (l = q(r) < R.length ? I[q(r)] : null) ? l.textBlock : null),
      ...
      function h(a, b) {
        return (
          (b < R.length ? I[b].textBlock.y : t.reversed ? U + z : sa + z) -
          (0 > a
            ? t.reversed
              ? sa - z
              : U - z
      ...
      function m(a, b, c) {
        ...
        a._animator.animate(
          ...
          function (c) {
            ...
            for (e = 0; e < R.length; e++) ta(d, R[e], t.fillOpacity);
            v(d);
            L && ('inside' !== t.indexLabelPlacement ? n(d) : f(), r(d));
            1 <= c && (ha = !1);
          },
          null,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var t = this.data[a.dataSeriesIndexes[0]],
            ...
            C = 0,
            E = y.height - 2 * z,
            G = Math.min(y.width - 2 * B, 2.8 * y.height),
            L = !1,
            S = 0;
          S < x.length;
          S++
          ...
          if (
            ...
            !L &&
              ...
              (L = !0),
            (!L && 'function' === typeof t.indexLabelFormatter) ||
        ...
        ('inside' !== t.indexLabelPlacement && L) ||
          (B = (y.width - 0.75 * G) / 2);
        var S = y.x1 + B,
          K = y.x2 - B,
          $ = y.y1 + z,
        ...
        if (0 != t.length && t.dataPoints && t.visible && 0 !== x.length) {
          ...
          var X = (30 * (K - a)) / 100;
          'funnel' === t.type
            ? ((Q = s(t.options.neckHeight) ? 0.35 * E : t.neckHeight),
              (F = s(t.options.neckWidth) ? 0.25 * a : t.neckWidth),
              ...
              F > a ? (F = a - 0.5) : 0 >= F && (F = 0))
            : 'pyramid' === t.type &&
              ((F = Q = 0), (t.reversed = t.reversed ? !1 : !0));
          var B = S + a / 2,
            T = S,
            V = S + a,
            U = t.reversed ? O : $,
          ...
          if (-1 !== S) {
            ...
            for (F = 0; F < x.length; F++)
              x[F].exploded &&
                ((S = !0), t.reversed ? Z.push(x.length - 1 - F) : Z.push(F));
            P.clearRect(y.x1, y.y1, y.width, y.height);
            P.fillStyle = A.backgroundColor;
            P.fillRect(y.x1, y.y1, y.width, y.height);
            if (
              L &&
              t.visible &&
            ...
            for (F = 0; F < R.length; F++)
              (C = R[F]), ta(P, C, t.fillOpacity), ia.push(C.y1);
            v(P);
            L &&
              t.visible &&
              ('inside' === t.indexLabelPlacement || A.animationEnabled || n(P),
    ...
    m.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if (
        ...
        do {
          ...
          a = a.replace('#percent', ca(l, m, f._cultureInfo));
          a = a.replace(
            '#total',
            ca(
              h,
                ...
                !a[g] ||
                  ...
                  0 < h
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      (0 < E && (l += E), 0 < h && (m -= h))),
                n.panEnabled
                  ? (W = s(n.sessionVariables.axisX.height)
                ...
                d[g]._labels &&
                  ...
                  (t =
                    ...
                    (h.textBlock.height - h.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                n.panEnabled
                  ? (Y = s(n.sessionVariables.axisX2.height)
              ...
              b[g] &&
                ...
                (N =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (h = Math.round(
                  f.y1 + Y + V < Math.max(N, p) ? Math.max(N, p) : f.y1 + Y + V
                )),
                (N =
                  0 < a.length
                    ? 0
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (N = 0; N < b.length; N++)
                  b[N] &&
                    b[N].labelAutoFit &&
                    ((m = b[N].lineCoordinates.x2), (l = m - W));
              d[g].lineCoordinates = {
                x1: m + P,
                y1: h,
                x2: m + P,
          ...
          if (
            ...
            for (
              ...
              if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                ...
                (y += n[r].dataPoint.y),
                  (z = n[r].dataPoint.x.getTime
                    ? n[r].dataPoint.x.getTime()
                    : n[r].dataPoint.x),
                  (z = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[z])),
